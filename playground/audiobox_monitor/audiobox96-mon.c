...
static void render_dashboard(const struct stats *s) {
    ...
    const char *pb_alsa_color = "\033[1;32m";
    if (pb_alsa_ratio < 0.20) pb_alsa_color = "\033[1;5;31m";
    else if (pb_alsa_ratio < 0.45) pb_alsa_color = "\033[1;33m";

    const char *usb_pipe_color = "\033[1;32m";
    if (usb_pipeline_ratio < 0.90) usb_pipe_color = "\033[1;31m";
    else if (usb_pipeline_ratio < 0.98) usb_pipe_color = "\033[1;33m";

    const char *cap_color = "\033[1;32m";
    if (cap_ratio > 0.85) cap_color = "\033[1;5;31m";
    else if (cap_ratio > 0.60) cap_color = "\033[1;33m";
    ...
    printf("\033[1;36m│\033[1;35m  [CLOCK SYNCHRONIZATION & CPU TIMING]                                  \033[1;36m│\033[0m\033[K\n");
    printf("\033[1;36m│\033[1;37m  Feedback Status: %-16s  Actual Rate:  %-11.2f Hz         \033[1;36m│\033[0m\033[K\n", s->feedback_synced ? "\033[1;32mSYNCED\033[1;37m" : "\033[1;31mUNSYNCED\033[1;37m", actual_rate);
    printf("\033[1;36m│\033[1;37m  Clock Drift:     \033[1;33m%+-7.2f Hz\033[1;37m        Target Cycle: %-5.2f ms (%-5d us)  \033[1;36m│\033[0m\033[K\n", drift, expected_ms, s->pb_packets_per_urb * 125);
    printf("\033[1;36m│\033[1;37m  Average Jitter:  \033[1;32m%-7.2f us\033[1;37m       Max Jitter:   \033[1;33m%-7.2f us\033[1;37m           \033[1;36m│\033[0m\033[K\n", avg_jitter_us, max_jitter_us);
    printf("\033[1;36m├────────────────────────────────────────────────────────────────────────┤\033[0m\033[K\n");

    printf("\033[1;36m│\033[1;35m  [AUTOMATED HEALTH ANALYSIS]                                           \033[1;36m│\033[0m\033[K\n");

    if (!s->playback_active && !s->capture_active) {
        printf("\033[1;36m│\033[1;37m  Device Status: \033[1;30m[ IDLE ] Waiting for audio application...              \033[1;36m│\033[0m\033[K\n");
    } else {
        if (s->pb_xruns > 0 || s->cap_xruns > 0) {
            printf("\033[1;36m│\033[1;37m  XRUN Events:   \033[1;31m[ FAIL ] Dropout occurred! Increase buffer size.       \033[1;36m│\033[0m\033[K\n");
        } else {
            printf("\033[1;36m│\033[1;37m  XRUN Events:   \033[1;32m[  OK  ] No dropouts. Stream is perfectly clean.       \033[1;36m│\033[0m\033[K\n");
        }

        if (s->pb_buffer_size > 0 && s->pb_alsa_unplayed <= s->pb_period_size && s->pb_buffer_size <= 32) {
            printf("\033[1;36m│\033[1;37m  ALSA Buffer:   \033[1;33m[ WARN ] Extreme low latency (16/32 frames) active.    \033[1;36m│\033[0m\033[K\n");
            printf("\033[1;36m│\033[1;37m                          Requires high CPU performance to maintain.    \033[1;36m│\033[0m\033[K\n");
        } else if (pb_alsa_ratio < 0.20 && s->pb_buffer_size > 32) {
            printf("\033[1;36m│\033[1;37m  ALSA Buffer:   \033[1;33m[ WARN ] Buffer is nearly empty. CPU is too slow!      \033[1;36m│\033[0m\033[K\n");
        } else {
            printf("\033[1;36m│\033[1;37m  ALSA Buffer:   \033[1;32m[  OK  ] Healthy fill level. CPU is keeping up.        \033[1;36m│\033[0m\033[K\n");
        }

        if (!s->feedback_synced) {
            printf("\033[1;36m│\033[1;37m  Clock Sync:    \033[1;31m[ FAIL ] Seeking clock frequency. Audio may pop.       \033[1;36m│\033[0m\033[K\n");
        } else if (fabs(drift) > 5.0) {
            printf("\033[1;36m│\033[1;37m  Clock Sync:    \033[1;33m[ WARN ] High drift detected. Audio engine correcting. \033[1;36m│\033[0m\033[K\n");
        } else {
            printf("\033[1;36m│\033[1;37m  Clock Sync:    \033[1;32m[  OK  ] Hardware pacing is flawlessly locked.         \033[1;36m│\033[0m\033[K\n");
        }

        if (max_jitter_us > ((expected_ms * 1000) * 0.90)) {
            printf("\033[1;36m│\033[1;37m  USB Jitter:    \033[1;33m[ WARN ] IRQ scheduling delayed. Check kernel tuning.  \033[1;36m│\033[0m\033[K\n");
        } else {
            printf("\033[1;36m│\033[1;37m  USB Jitter:    \033[1;32m[  OK  ] Hardware IRQ timing is highly stable.         \033[1;36m│\033[0m\033[K\n");
        }
    }
